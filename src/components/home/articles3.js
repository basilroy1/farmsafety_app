          ...
          <ExpansionPanel>
            <div className="Topic1">
              <ExpansionPanelSummary
                ...
                id="panel1a-header" // here are safety articles for Inetermediate level
              >
                <Typography>
                  {" "}
                  Guarding Intermediate
                  <GiSwordsEmblem />
                </Typography>
              </ExpansionPanelSummary>
            </div>
            ...
            <Card>
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="0">
                  Guarding 3 <GiSwordsEmblem /> <FaChevronRight />
                </Accordion.Toggle>
              </Card.Header>
            ...
            <Card>
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="1">
                  Machinery Checks <MdCheckBox /> <FaChevronRight />
                </Accordion.Toggle>
              </Card.Header>
