          ...
          <div className="instructionsContent">
            ...
            <div className="description">
              <p>
                ...
                successful with these Quizzes, it’s important to thoroughly read
                each corresponding safety article. It will also be extremely
                useful to study the <strong>key terms</strong> and{" "}
                <strong>pictures </strong>at the duration of the article and
                review the
                <em> Take the Quiz</em> activity at the end of the Article. Keep
              ...
              <ul>
                ...
                <li>
                  ...
                  <strong> Rookie</strong>. Once the User reads the article and
                  attempts the Quiz and achieves the
                  <br /> <strong>required 50%</strong> the User moves up to next
                  level in this case it's Student etc. If the User{" "}
                ...
                <li>
                  <strong>Previous Quizes</strong> - You can take the older Quiz
                  again and again to brush up your Knowledge.
                </li>
                <li>
